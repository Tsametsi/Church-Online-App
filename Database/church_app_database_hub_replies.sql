...
--
-- Table structure for table `hub_replies`
--

DROP TABLE IF EXISTS `hub_replies`;
...
--
-- Dumping data for table `hub_replies`
--

LOCK TABLES `hub_replies` WRITE;
/*!40000 ALTER TABLE `hub_replies` DISABLE KEYS */;
/*!40000 ALTER TABLE `hub_replies` ENABLE KEYS */;
UNLOCK TABLES;
